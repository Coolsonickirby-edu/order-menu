	...
	<div id="container">
		...
		<form action="order2.php" method="post" id="myform">
			...
			<table class="tablectr">
				...
				if ($turkey > 0) {
					$itemtotal = $turkey * 8.99;
					$subtotal = $subtotal + $itemtotal;
					echo "<tr><td>Chipotle Honey Mustard Turkey Wrap</td><td class=\"center\">$turkey</td><td class=\"center\">$8.99</td><td class=\"center\">$$itemtotal</td></tr>";
				...
				<table class="tablectr">
					...
					<tr>
						<td colspan="4">* We only accept Mastercard, Visa, Discover, and American Express</td>
					</tr>
